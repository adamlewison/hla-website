...
<head>
    ...
    <title>HLA Architects | South Africa</title>
</head>
<body>
...
<div id="mainbar" class="container">
    ...
    <div id="gallery" style="display: none;">
        ...
        $r = DB::table('project_images')->get()->toArray();
        // (Sigma)p(x) = P(x)
        ...
        ?>
        <a href="/projects/<?= $obj->project_id ?>">
            <img alt="<?= ' ' ?>" src="<?= $src ?>" data-image="<?= $src ?>" data-description="<?= $obj->name; ?>. Image score: <?= $obj->score ?>" >
            Score~: <?= $obj->score ?>
        </a>
        <?php
