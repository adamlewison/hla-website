...
@section('content')
    <div class="container">
        ...
        <form action="/projects/{{ $project->id }}/update" method="post">
            ...
            <div class="form-group">
                <input type="text" name="client" value="{{ $project->client }}" placeholder="client"
                    class="form-control">
            </div>

            <div class="form-group form-check">
                <input name="live" type="checkbox" class="form-check-input"
                    {{ $project->live == 'on' ? "checked='checked'" : '' }}>
            ...
            @foreach ($project->project_images as $img)
                <div class="col mb-4">
                    <div class="card" style="width: 18rem;">
                        <img src="http://www.hla.co.za/images/project_images/{{ $img->name }}" class="card-img-top"
                            alt="...">
